let prompts = [
    {
        ...
        txt: `In every direction you look, the roads are hemmed in by a variety of buildings. Some L-shaped and made of white stone (temples, perhaps), others simple timber constructions with thatch roofs, all teeming with life and the sound of Latin. Some have vividly painted outer walls, their colours popping out amidst the gray sky and dirty roads. 
        
        You see another massive brick-built structure to your right, its entrance adorned with fine red fabrics. You initially believe it to be a temple, but as you look closer you see the distinct rise of steam from some of the windows-a bathhouse! Here men can sweat out their suffering and find peaceful recreation. It's tempting, but you must move onwards towards the forum.`,
        choices: [{ nextId: 5, txt: "Take a stroll down the street." }, { nextId: 30, txt: "The Forum." }]
    }, {
        ...
        txt: `You don your cloak to shelter from the rain, grab your coin purse, and exit outside. Your father is atop a ladder resting on the wall next to the door, methodically pulling tiles off the roof, tossing them onto the grass, and replacing them with new ones. 
        
        You remember him mentioning a few days prior that he had fired new tiles for the roof but had put off installing them as the weather had been calm. Or perhaps you were supposed to do it? You hear him cursing under his breath so perhaps the latter.`,
        choices: [{ nextId: 19, txt: "Avoid Him and Head to the Herb Garden" }]
    }, {
        txt: `Not wanting to risk being chastised, you opt to go around to the other side of the house and see how your herbs are doing. You had considered growing a small field of spelt this year as well, but your uncle - the family farmer - insisted against it. You sensed he's already apprehensive about giving up herb duty and figured not to push him, content with the humble sanctuary you've been left with. 
        
        Walled in by wattle fences your mother had woven, you watch the raindrops rattle the leaves and stalks of the various plants. Dill, celery, mustard, bullace, some stinging nettle and blackberry you hadn't bothered picking - enough to fill a cornucopia. It's best to wait until it's dryer to pick them, although the dill looks particularly appetizing in the rain.`,
        choices: [{ nextId: 20, txt: "Continue to the River" }]
    }, {
        txt: `With your cloak keeping you warm and your father still working, you figure it best to continue a few hundred pedes onwards to the river. Despite the sour weather and gray skies, the vista is as gorgeous as ever. The rolling green hills shimmer in the wetness; the clusters of trees scattered along the landscape stand firm against the wind. Mice scatter as you march through tall grass; several cows shelter under a grand apple tree. 
        
        You're amazed that the tree is still fruitful considering the river floods this valley every winter. You walk along the banks of the river and watch it flow, the rain making its current more aggressive than usual. It's noticeably low this time of year, ill-matched for a powerful name like Tamesis in its current state. The rain is starting to become bitingly cold. A fire would be nice right now.`,
        ...
        Oh how you wish someone would rob you and free you from this boredom! 
        
        Eventually, as your feet begin to tire, you see the bustle of the town in the distance and begin your approach towards the south gate.`,
        ...
        What will you buy?`,
        choices: [{ nextId: 35, txt: "Amphora of Oil" }, { nextId: 36, txt: "Barrel of Wine" }]
    }, {
        txt: `Too interested by the amphora's fanciful design, you give over your money and decide to take it home. Decoratively painted on the rim is a simple depiction of two wolves playing. You're not quite sure what you'll do with this oil, but surely your grandmother will have an idea. You worry that you've overpaid for only half an amphora. 
        
        As you begin the long walk home and already grow slightly uncomfortable with its weight, you suddenly become thankful it's not full.`,
        choices: [{ nextId: 47, txt: "Return Home" }]
    }, {
        ...
        choices: [{ nextId: 39, txt: "Gazelle Figurine" }, { nextId: 40, txt: "Crocodile Teeth" }]
    }, {
        ...
        choices: [{ nextId: 45, txt: "Epicurean Writings" }, { nextId: 46, txt: "Suspicious Horn" }]
    }, {
        ...
        Your father has gotten the roof retiled despite the rain and, as you enter, he greets you warmly.
