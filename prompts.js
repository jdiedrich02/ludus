let prompts = [
    {
        ...
        choices: [{ nextId: 6, txt: "Join the group and play a game." }, { nextId: 3, txt: "Continue on down the street." }]
    }, {
        ...
        choices: [{ nextId: 6, txt: "Wait around and play another Ludus game once the board is freed up" }, { nextId: 3, txt: "Move on with the rest of your day, perhaps visit the market like you planned to do." }]
    }, {
        ...
        choices: [{ nextId: 13, txt: "Stoke the Fire" }, { nextId: 17, txt: "Investigate the Noise" }]
    }, {
        ...
        choices: [{ nextId: 14, txt: "Stoke the Fire" }, { nextId: 17, txt: "Investigate the Noise" }]
    }, {
        txt: "Thick smoke begins to fill the room. Have you considered opening the door?",
        choices: [{ nextId: 15, txt: "Stoke the Fire" }, { nextId: 17, txt: "Investigate the Noise" }]
    }, {
        ...
        choices: [{ nextId: 18, txt: "Avoid Him and Head to the Herb Garden" }]
    }, {
        ...
        choices: [{ nextId: 19, txt: "Continue to the River" }]
    }, {
        ...
        choices: [{ nextId: 20, txt: "Continue to your Uncle's" }]
    }, {
        ...
        choices: [{ nextId: 22, txt: "Sit by the Fire in Silence" }, { nextId: 24, txt: '"Need any help, Uncle?"' }]
    }, {
        ...
        choices: [{ nextId: 23, txt: "He Grabs Your Arm" }]
    }, {
        ...
        choices: [{ nextId: 26, txt: "Road to Calleva" }]
    }, {
        ...
        txt: "Road to Calleva",
        choices: [{ nextId: 27, txt: "The Forum" }]
    }, {
        txt: "The Forum",
